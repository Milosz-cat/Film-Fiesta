...
class MovieModelTest(TestCase):
    """
    Unit tests for the models in the base application.

    This test suite ensures that the models function as expected. It tests the creation
    of a instances and verifies its attributes.

    Methods:
        setUp(): Initializes a mock model instance for testing purposes.
        test_model_creation(): Tests the creation of a model instance and verifies its attributes.
    """
...
class PersonModelTest(TestCase):
    def setUp(self):
        Person.objects.create(
            name="Test Person", custom_id=1, role="Actor", profile_path="test_path"
        )
