...
class Review(models.Model):
    """Represents a user's review for a specific movie, including the content and timestamps."""
...
class Comment(models.Model):
    """Represents a user's comment on a movie review, including the content and timestamps."""
    user = models.ForeignKey(User, on_delete=models.CASCADE, default=None)
