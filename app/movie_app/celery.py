...
app.conf.beat_schedule = {
    """
Define the beat schedule for periodic tasks. This configuration sets up three tasks to run
at specified intervals.
- scrape_imdb_top_250: This task scrapes the IMDB Top 250 movies. It's scheduled to run every
day at midnight.
