...
class OscarWinnerTestCase(TestCase):
    def setUp(self):
        OscarWinner.objects.create(year="2020", release_year=2020, title="Test Winner", studio="Test Studio")
...
class OscarNominationTestCase(TestCase):
    def setUp(self):
        winner = OscarWinner.objects.create(year="2020", release_year=2020, title="Test Winner", studio="Test Studio")
        OscarNomination.objects.create(winner=winner, title="Test Nominee", release_year=2020, studio="Test Studio Nominee")
