...
class SignalsTest(TestCase):
    ...
    def test_create_watchlist_signal(self):
        ...
        self.assertTrue(PersonList.objects.filter(user=user, name="Favourite Actors").exists())
        self.assertTrue(PersonList.objects.filter(user=user, name="Favourite Directors").exists())
